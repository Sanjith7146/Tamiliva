...
//  Tamiliva
//
//  Created by sanjithsethu on 27/2/22.
//
    ...
    var body: some View {
        if value != 3 && value != 4 {
            VStack(alignment:.leading){
                Text("")
                List{
                    ForEach(phrases[value],id:\.self){ ph in
                        VStack(alignment:.leading){
                            Text(ph.phrase)
                                .font(.system(size: 19))
            ...
            VStack{
                ...
                List{
                    ForEach(phrases[value],id:\.self){ ph in
                        ...
                        NavigationLink(destination:MeaningView(phrase: ph.phrase, definition: ph.meaning)){
                            Text(ph.phrase)
                                .font(.system(size: 19))
                                .foregroundColor(Color(red: 0.0, green: 0.27450980392156865, blue: 0.6862745098039216))
                                .fontWeight(.bold)
