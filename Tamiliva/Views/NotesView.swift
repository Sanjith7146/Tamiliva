...
struct NotesView: View {
    ...
    struct NotesView_Previews: PreviewProvider {
        static var previews: some View {
            NotesView(notes: .constant([Note(name: "Tamil Phrases", description: "I am a tamil man and I am very proud of that. COOOOOOOOLLLL", dateAdded: Date.now, fav: "♡")]), notesFavourites: .constant([Note(name: "Nice", description: "All works, but ddoes it????", dateAdded: Date.now, fav: "♥︎")]))
        }
    }
}
